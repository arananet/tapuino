// Incluyo la versión en español - @edu_arana <http://arananet-net.kinja.com>
...
const char S_SELECT_RECORD_MODE[] PROGMEM = "Modo nombre:";
...
const char S_SELECT_FILE[] PROGMEM = "Elegir fichero:";
const char S_SELECT_MODE[] PROGMEM = "Modo seleccion:";
...
const char S_OPTION_MACHINE_TYPE[] PROGMEM = "Maquina";
